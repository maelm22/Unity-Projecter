...
public class MidPointDisplacement : ScriptableWizard
{
    ...
    public void GenerateTerrain(Terrain t)
    {
        ...
        int arraySize = (int)Mathf.Pow(2, terrainSize) + 1;
        //once we know how long is a side, let's set up the terrain resolution to that
        t.terrainData.heightmapResolution = arraySize;

        // we create the hts matrix, where we will store our new heighmap values. This matrix will have size "arraySize x arraySize"
