...
public class GameController : MonoBehaviour
{
    ...
    private readonly string[] startingState =
    {
        ".", ".", ".",
        ".", ".", ".",
        ".", ".", "."
    ...
    private void AIMove()
    {
        var res = MiniMax.Minimax(currentState, treeDepth,
            true); // NOTE: the higher the depth is, the "smarter" the AI is
        var move = res[1];
        var value = res[0];
    ...
    public void RestartGame()
    {
        ...
        for (var i = 0; i < buttonList.Length; i++) buttonList[i].text = "";
    }

    private void SetBoardInteractable(bool toggle)
    {
        for (var i = 0; i < buttonList.Length; i++) buttonList[i].GetComponentInParent<Button>().interactable = toggle;
    }
